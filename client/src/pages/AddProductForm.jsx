...
// Helper to format as Indian Rupee with only symbol (no "INR" text)
...
export default function ProductTable({
  ...
  const handleView = (id) => {
    ...
    if (found) {
      ...
      axios
        .get(`https://acc-in-touch-1.onrender.com/api/Product/${id}`)
        .then((res) => {
  ...
  const confirmDelete = async () => {
    try {
      await axios.delete(
        `https://acc-in-touch-1.onrender.com/api/Product/${deleteId}`
      );
      setProducts((prev) =>
        prev.filter((p) => {
                ...
                return (
                  <tr key={pid} className="product-row" role="row">
                    ...
                    <td className="col-price" role="cell">
                      {p.basicPricing !== undefined && p.basicPricing !== null && p.basicPricing !== ""
                        ? formatINR(p.basicPricing)
                        : "—"}
                    </td>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontWeight: 700 }}>
                      ...
                      viewProduct.basicPricing !== null &&
                      viewProduct.basicPricing !== ""
                        ? formatINR(viewProduct.basicPricing)
                        : "—"}
                    </div>
                  </div>
